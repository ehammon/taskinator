...
//create a new list item and setting div, attributes, id
...
// create delete and edit buttons, status drop-down 
  ...
  //create drop down menu for status
  ...
  for (var i = 0; i < statusChoices.length; i++) {
    ...
    //append to select
    statusSelectEl.appendChild(statusOptionElement);
  }
...
// add functionality to buttons when clicked
...
// changing the status of a task and moving into different column
